...
export default function signin(){
    ...
    const [ buttonText, setButtonText ] = useState("Log In to your Account")
    ...
    const handleSignup = async () => {
        setDisabled(true)
        setButtonText("Authenticating your account details...")
        axios.post(URL, {
        ...
        { withCredentials: true }
            ...
            if(res.data.success){
                if (alerDivtRef.current) {
                    alerDivtRef.current.innerText = "Signin Successful.";
                }
                setButtonText("Redirecting to the home page...")
                setTimeout(() => {
            ...
            <div className="w-full h-[95%] flex flex-col gap-5 items-center justify-start mt-15">
                ...
                <div className="h-fit w-[85%] bg-[#181818] rounded-md p-5 sm:w-110" >
                    <div className="flex w-full items-center justify-center flex-col ">
                        <div className="text-white font-semibold text-2xl text-center">Log In to your Account</div>
                    ...
                    <div className="flex flex-col gap-6" >
                        ...
                        <InputBox title="Password" type="password" name="password" height={12} maxLength={50} onChange={handleInputChange} onKeyDown={(e) => {
                            if(e.key === "Enter"){
                                handleSignup();
                            }
                        }} />
                        ...
                        <div className="flex justify-center">
                            <Button variant="secondary" size="lg" text="Create a New Account" onClick={() => {
                                router.push("/signup")
                            }} />
                        </div>
                    </div>
